...
# Increase font size
# Remove superfluous sections, eg (mentoring, class tutor, etc (as that might apply to other job listings at least)
# Follow up with Topresume regarding meaning of 'visually uneven'.
...
- <i class="fab fa-canadian-maple-leaf" style = "font-size:16px"></i> &nbsp; Canadian Citizen

- <i class='fa fa-kiwi-bird'></i> &nbsp; New Zealand Citizen

- <i class='fas fa-flag-usa' style = "font-size:12px"></i> &nbsp; [USA TN1 Eligible](https://www.lawfirm4immigrants.com/tn-visa-for-research-assistant/)
<p stype = "margin: -0.20em 0cm 0em;">
 &nbsp; &nbsp; &nbsp; &nbsp; [- *Research Assistant*](https://www.lawfirm4immigrants.com/tn-visa-for-research-assistant/)
</p>
...
Disclaimer {#disclaimer}
--------------------------------------------------------------------------------
<p style = "margin: -11em 0em 0em;">
Made w/ [*pagedown*](https://github.com/rstudio/pagedown). <br>
Last updated on `r Sys.Date()`. <br>
View my source code [here.](https://github.com/uberkeil/kyle_CV)
<br>
<br>
<br>
Page 2 of 2
