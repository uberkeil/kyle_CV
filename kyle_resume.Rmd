...
- <i class='fas fa-flag-usa' style = "font-size:12px"></i> &nbsp; TN1 Eligible For USA 
<br> 
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; (Research Assistant)
...
Source code: [github.com/uberkeil/kyle_CV](https://github.com/uberkeil/kyle_CV).<br>
